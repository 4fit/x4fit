...
public class CommentDetailPost {
	...
	public CommentDetailPost(int id, int user_id, int post_id, int level, int points, int commentable_id, String in_reply_to_comment,
	...
	public CommentDetailPost(Document cmtDoc, Document userDoc)
	{
		
		
		try
		 {
			this.user_id = cmtDoc.getInteger("user_id");
		 }
		catch(Exception e)
		{
			this.user_id = Integer.parseInt(cmtDoc.getString("user_id"));
		}
