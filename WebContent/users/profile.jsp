            ...
            <div class="profile-banner container-fluid ">
                <div class="container  ml-2">
                    ...
                    <div class="info-ban">
                        ...
                        <p class="gmail-ban">${curUser.getEmail(curUser.getUserID())}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <c:when test="${updateSuccess==false}">
                        ...
                        <button class="tablink" onclick="openPage('Following', this)">Following</button>
                        <button class="tablink" onclick="openPage('Follower',this)">Follower</button>
                        <button class="tablink" onclick="openPage('Setting',this)"  id="defaultOpen">Setting</button>
                    </c:when>
                    </c:choose>
                                    ...
                                    <div class="col-sm-6 col-md-4 anuser" >
                                        <div class="d-flex exhibition-item user mt-4">
                                            ...
                                            <div class="user-info overflow-hidden">
                                                <a class="username" href="${pageContext.request.contextPath}/viewprofile?email=${user.getEmail(user.getUserID())}">${user.getFullname()}</a>
                                                <div class="user-icon">
                                                    <span class="viewtag t ">
                        ...
                        <div id="Setting" class="tabcontent">
                            <div class="row content">
                                <div class="col-md-2 setting-btn">
                                    ...
                                    <button type="button" class="btn gallery">GALLERY </button>
                                ...
                                <div class="col-md-10 setting-row">
                                    ...
                                    <input type="radio" id="gallery" name="name" />
                                    <div class="container">Hi</div>
                                    <input type="radio" id="contact" name="name" />
                    ...
                    <div class="list-static col-lg-3 hidden-md-down float-right">
                        <ul class="list-group ">
                            <li class="list-group-item  d-flex justify-content-between align-items-center">
                                Total post view
                                <span class="badge badge-primary badge-pill">${curUser.coutTotalPostView(curUser.getUserID())}</span>
                            </li>
